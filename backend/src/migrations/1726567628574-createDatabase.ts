...
export class CreateDatabse1726567628574 implements MigrationInterface {
    name = 'CreateDatabse1726567628574'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`mission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`picture\` varchar(255) NULL, \`description\` text NOT NULL, \`category\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`deadline\` date NOT NULL, \`numberOfHours\` int NOT NULL, \`volunteerNumber\` int NOT NULL, \`isDone\` tinyint(1) NOT NULL DEFAULT '0', \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`organization_id\` int NULL, INDEX \`IDX_b554181bece934fc8fc90619cf\` (\`organization_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
