        ...
        <>
            <div className="w-full h-full flex flex-col justify-center items-center">
                <div className="w-[90%] p-[25px] bg-white/50 rounded-[10px] relative shadow-md mb-[50px]">
                    <div className="text-title text-[20px] font-bold mb-[50px]">Inscription Association</div>
                    <form onSubmit={handleSubmit} className="grid grid-rows-[repeat(6, auto)] gap-[20px]">
                        ...
                        <label className="orgname text-title text-[16px] font-bold flex flex-col">Nom de l'association
                            <input className="rounded-sm h-[30px] px-[2px] py-0 border-b border-solid border-black/12" type="text" name="organization_name" onChange={handleChange} value={formData.organization_name} />
                        </label>
                        ...
                        </label>    //Je propose d'y mettre en commentaire pour l'instant, au pire on pourra y mettre dans un autre formulaire accessible pour se faire vérifier par les admins */}
                        ...
                        <label className="password text-title text-[16px] font-bold flex flex-col">Mot de passe
                            <input className="rounded-sm h-[30px] px-[2px] pr-[100px] py-0 border-b border-solid border-black/12" type="password" name="password" onChange={handleChange} value={formData.password} />
                        </label>
